...
For a namespace, name, we write out:
  ...
  -- name_params.H  (for logi, included in Logi.H):
     sets up the namespace and extern parameters

  -- name_declares.H  (for logi, included in Logi.cpp):
     declares the runtime parameters

  -- name_queries.H  (for logi, included in Logi.cpp):
...
CWARNING = """
// This file is automatically created by parse_logi_params.py at build time.
