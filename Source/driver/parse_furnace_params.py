...
For a namespace, name, we write out:
  ...
  -- name_params.H  (for furnace, included in Furnace.H):
     sets up the namespace and extern parameters

  -- name_declares.H  (for furnace, included in Furnace.cpp):
     declares the runtime parameters

  -- name_queries.H  (for furnace, included in Furnace.cpp):
...
CWARNING = """
// This file is automatically created by parse_furnace_params.py at build time.
