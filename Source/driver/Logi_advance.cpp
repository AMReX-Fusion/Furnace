...
void
Logi::initialize_do_advance(Real time)
{

    BL_PROFILE("Logi::initialize_do_advance()");
...
void
Logi::finalize_do_advance()
{
    BL_PROFILE("Logi::finalize_do_advance()");
...
void
Logi::initialize_advance(Real time, Real dt, int amr_iteration, int amr_ncycle)
{
    BL_PROFILE("Logi::initialize_advance()");
...
void
Logi::finalize_advance()
{
    BL_PROFILE("Logi::finalize_advance()");
