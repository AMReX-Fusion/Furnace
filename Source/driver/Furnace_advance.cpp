...
void
Furnace::initialize_do_advance(Real time)
{

    BL_PROFILE("Furnace::initialize_do_advance()");
...
void
Furnace::finalize_do_advance()
{
    BL_PROFILE("Furnace::finalize_do_advance()");
...
void
Furnace::initialize_advance(Real time, Real dt, int amr_iteration, int amr_ncycle)
{
    BL_PROFILE("Furnace::initialize_advance()");
...
void
Furnace::finalize_advance()
{
    BL_PROFILE("Furnace::finalize_advance()");
