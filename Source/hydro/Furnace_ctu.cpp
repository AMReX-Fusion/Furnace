...
void
Furnace::consup_hydro(const Box& bx,
#ifdef SHOCK_VAR
...
void
Furnace::ctu_ppm_states(const Box& bx, const Box& vbx,
...
#ifdef RADIATION
void
Furnace::ctu_ppm_rad_states(const Box& bx, const Box& vbx,
                           Array4<Real const> const& q_arr,
                           Array4<Real const> const& flatn,
                           Array4<Real const> const& qaux_arr,
                           Array4<Real const> const& srcQ,
...
void
Furnace::ctu_plm_states(const Box& bx, const Box& vbx,
                       Array4<Real const> const& q_arr,
...
void
Furnace::add_sdc_source_to_states(const Box& bx, const int idir, const Real dt,
...
void
Furnace::src_to_prim(const Box& bx, const Real dt,
                    Array4<Real const> const& q_arr,
