...
void
Logi::consup_hydro(const Box& bx,
#ifdef SHOCK_VAR
...
void
Logi::ctu_ppm_states(const Box& bx, const Box& vbx,
...
#ifdef RADIATION
void
Logi::ctu_ppm_rad_states(const Box& bx, const Box& vbx,
                           Array4<Real const> const& q_arr,
                           Array4<Real const> const& flatn,
                           Array4<Real const> const& qaux_arr,
                           Array4<Real const> const& srcQ,
...
void
Logi::ctu_plm_states(const Box& bx, const Box& vbx,
                       Array4<Real const> const& q_arr,
...
void
Logi::add_sdc_source_to_states(const Box& bx, const int idir, const Real dt,
...
void
Logi::src_to_prim(const Box& bx, const Real dt,
                    Array4<Real const> const& q_arr,
