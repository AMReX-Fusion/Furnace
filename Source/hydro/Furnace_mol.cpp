...
void
Furnace::mol_plm_reconstruct(const Box& bx,
                            const int idir,
...
void
Furnace::mol_ppm_reconstruct(const Box& bx,
                            const int idir,
                            Array4<Real const> const& q_arr,
                            Array4<Real const> const& flatn_arr,
                            Array4<Real> const& qm,
...
void
Furnace::mol_consup(const Box& bx,
#ifdef SHOCK_VAR
...
void
Furnace::mol_diffusive_flux(const Box& bx,
                           const int idir,
