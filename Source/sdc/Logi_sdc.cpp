#include <Logi.H>
#include <Logi_F.H>
// #include <Logi_hydro_F.H>
#include <Logi_sdc_util.H>

using namespace amrex;

void
Logi::do_sdc_update(int m_start, int m_end, Real dt)
{

    BL_PROFILE("Logi::do_sdc_update()");
...
#ifdef REACTIONS
void
Logi::construct_old_react_source(MultiFab& U_state,
                                   MultiFab& R_source,
                                   const bool input_is_average)
{

    BL_PROFILE("Logi::construct_old_react_source()");
