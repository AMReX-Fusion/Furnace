#include <Furnace.H>
#include <Furnace_F.H>
// #include <Furnace_hydro_F.H>
#include <Furnace_sdc_util.H>

using namespace amrex;

void
Furnace::do_sdc_update(int m_start, int m_end, Real dt)
{

    BL_PROFILE("Furnace::do_sdc_update()");
...
#ifdef REACTIONS
void
Furnace::construct_old_react_source(MultiFab& U_state,
                                   MultiFab& R_source,
                                   const bool input_is_average)
{

    BL_PROFILE("Furnace::construct_old_react_source()");
