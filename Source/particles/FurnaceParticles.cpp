...
AmrTracerParticleContainer* Furnace::TracerPC =  0;
...
void
Furnace::init_particles ()
{
    BL_PROFILE("Furnace::init_particles()");
...
void
Furnace::ParticleCheckPoint(const std::string& dir)
{
    if (level == 0)
    {
        if (TracerPC)
...
void
Furnace::ParticlePlotFile(const std::string& dir)
{
    if (level == 0)
    {
...
void
Furnace::ParticlePostRestart (const std::string& restart_file)
{
    if (level == 0)
    {
        if (do_tracer_particles)
...
Furnace::ParticleDerive(const std::string& name,
                       Real               time,
                       int                ngrow)
{
    BL_PROFILE("Furnace::ParticleDerive()");
...
void
Furnace::TimestampParticles (int ngrow)
{
...
void
Furnace::advance_particles(int iteration, Real time, Real dt)
{
    if (TracerPC)
    {
        int ng = iteration;
