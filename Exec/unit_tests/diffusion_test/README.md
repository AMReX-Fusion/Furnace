...
diffusion solver in Logi to diffuse a Gaussian thermal pulse.
Because diffusion in Logi is incorporated in the energy equation, we
are solving:

   d(ρe)/dt = ∇·(k ∇T)

where L is the Laplacian and k is the thermal conductivity.  Here we
assume that k is constant, but Logi does not require that
...
It also will use the Logi problem-specific post-simulation hooks (in
...
```
./Logi2d.gnu.ex inputs.2d.sph
./Logi2d.gnu.ex inputs.2d.sph amr.n_cell=128 256
./Logi2d.gnu.ex inputs.2d.sph amr.n_cell=256 512
```
...
```
./Logi1d.gnu.ex inputs.1d logi.time_integration_method=2 logi.sdc_order=4 amr.n_cell=64
./Logi1d.gnu.ex inputs.1d logi.time_integration_method=2 logi.sdc_order=4 amr.n_cell=128
./Logi1d.gnu.ex inputs.1d logi.time_integration_method=2 logi.sdc_order=4 amr.n_cell=256
./Logi1d.gnu.ex inputs.1d logi.time_integration_method=2 logi.sdc_order=4 amr.n_cell=512
```
...
```
 ./Logi1d.gnu.ex inputs.1d.powerlaw amr.n_cell=64
 mv diffuse_plt00048 diffuse_64
 ./Logi1d.gnu.ex inputs.1d.powerlaw
 mv diffuse_plt00191 diffuse_128
 ./Logi1d.gnu.ex inputs.1d.powerlaw amr.n_cell=256
...
```
./Logi1d.gnu.ex inputs.1d.powerlaw logi.time_integration_method=2 logi.sdc_order=4 amr.n_cell=64
mv diffuse_plt00048 diffuse_64
./Logi1d.gnu.ex inputs.1d.powerlaw logi.time_integration_method=2 logi.sdc_order=4
mv diffuse_plt00190 diffuse_128
./Logi1d.gnu.ex inputs.1d.powerlaw logi.time_integration_method=2 logi.sdc_order=4 amr.n_cell=256
mv diffuse_plt00760 diffuse_256
./Logi1d.gnu.ex inputs.1d.powerlaw logi.time_integration_method=2 logi.sdc_order=4 amr.n_cell=512
...
```
mpiexec -n 16 ./Logi2d.gnu.MPI.ex inputs.2d.powerlaw logi.time_integration_method=2 logi.sdc_order=4 amr.n_cell=64 64
mv diffuse_plt00039 diffuse_2d_64
mpiexec -n 16 ./Logi2d.gnu.MPI.ex inputs.2d.powerlaw logi.time_integration_method=2 logi.sdc_order=4
mv diffuse_plt00157 diffuse_2d_128
mpiexec -n 16 ./Logi2d.gnu.MPI.ex inputs.2d.powerlaw logi.time_integration_method=2 logi.sdc_order=4 amr.n_cell=256 256
mv diffuse_plt00626 diffuse_2d_256
mpiexec -n 16 ./Logi2d.gnu.MPI.ex inputs.2d.powerlaw logi.time_integration_method=2 logi.sdc_order=4 amr.n_cell=512 512
