...
# run as: ./sedov_2d_cyl_in_cart.py logi_dir plotfle
...
def process(logi_dir, plotfile):
    ...
    analytic = logi_dir + "/Exec/hydro_tests/Sedov/Verification/cylindrical_sedov.dat"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        sys.exit("usage: ./sedov_2d_cyl_in_cart.py logi_dir plotfile")
