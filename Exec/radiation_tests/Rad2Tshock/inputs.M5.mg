...
logi.do_hydro       = 1
logi.do_radiation   = 1
logi.do_reflux      = 1       # 1 => do refluxing
logi.do_react       = 0       # reactions?

# hydro cutoff parameters
logi.small_dens     = 1.e-20

# External source terms
logi.add_ext_src=0            #  Add external source terms

# TIME STEP CONTROL
logi.cfl            = 0.8     # cfl number for hyperbolic system
logi.init_shrink    = 0.1     # scale back initial timestep
logi.change_max     = 1.1 
#logi.initial_dt     = 0.01

#logi.fixed_dt       = 1.e-15
