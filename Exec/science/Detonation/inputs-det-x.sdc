...
furnace.sdc_order = 2
furnace.sdc_solver = 2
furnace.sdc_solver_tol_dens = 1.e-5
furnace.sdc_solver_tol_spec = 1.e-5
furnace.sdc_solver_tol_ener = 1.e-5
furnace.sdc_newton_use_analytic_jac = 0
