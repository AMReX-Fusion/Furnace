...
# base grid resolution is 160 km.  max_level = 2 is 40 km (that's "low res")
...
furnace.cfl            = 0.4     # cfl number for hyperbolic system
furnace.init_shrink    = 0.01     # scale back initial timestep by this factor
furnace.change_max     = 1.2    # factor by which dt is allowed to change each timestep
furnace.sum_interval   = 1       # timesteps between computing and printing volume averages

furnace.drive_initial_convection = 1
furnace.drive_initial_convection_reinit_period = 1
furnace.drive_initial_convection_tmax = 10
