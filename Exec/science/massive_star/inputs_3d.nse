...
logi.cfl            = 0.4     # cfl number for hyperbolic system
...
logi.drive_initial_convection = 1
logi.drive_initial_convection_reinit_period = 1
logi.drive_initial_convection_tmax = 10
